...
function sendBudget(){
  ...
  let message="Olá, Engenheiro Christian! Vim pelo portal digital da Renderização e gostaria de solicitar um orçamento.";
  message+="%0A%0AServiço de interesse: "+encodeURIComponent(service);
  if(name){message+="%0ANome/empresa: "+encodeURIComponent(name)}
  if(note){message+="%0ADescrição: "+encodeURIComponent(note)}
...
function sharePortal(){
  const data={title:"Renderização Serviços de Engenharia",text:"Portal digital da Renderização Serviços de Engenharia",url:window.location.href};
...
const serviceGalleries = {
  pavimentacao: {
    ...
    desc: "Fotos de obras, materiais, execução, acompanhamento técnico e controle de campo.",
    folder: "img/servicos/pavimentacao/",
    photos: ["foto01.jpg","foto02.jpg","foto03.jpg","foto04.jpg","foto05.jpg","foto06.jpg"]
  },
  saneamento: {
    title: "Saneamento",
    desc: "Fotos de redes, drenagem, infraestrutura urbana, acompanhamento e registros técnicos.",
    folder: "img/servicos/saneamento/",
    photos: ["foto01.jpg","foto02.jpg","foto03.jpg","foto04.jpg","foto05.jpg","foto06.jpg"]
  },
  pericias: {
  ...
  controle: {
    title: "Acompanhamento técnico e controle tecnológico",
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  document.querySelectorAll("[data-count]").forEach(el=>{
    ...
    let current=0;
    let step=Math.max(1,Math.floor(target/45));
